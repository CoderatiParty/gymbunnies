...
class Workout(db.Model):
    ...
    workout_type = db.Column(db.Enum('select', 'Arms', 'Back', 'Cardio', 'Chest', 'Core', 'Fullbody', 'Legs', 'Lower', 'Pull', 'Push', 'Upper', name='workout_type_enum'), default='select', nullable=False) # Specific options for the workout type
