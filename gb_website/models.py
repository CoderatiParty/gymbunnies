...
class Workout(db.Model):
    ...
    workout_type = db.Column(db.Enum('Arms', 'Back', 'Cardio', 'Chest', 'Core', 'Fullbody', 'Legs', 'Lower', 'Pull', 'Push', 'Upper', name='workout_type_enum'), default='Arms', nullable=False) # Specific options for the workout type
